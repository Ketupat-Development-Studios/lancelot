<?php
	...
	else if($query == "getlancersbyid" && isset($_GET["id"])){ //Get all freelancers by freelancer id
	...
	else if($query == "getlancersbycat" && isset($_GET["id"])){ //Get all freelancers in a category
	...
	else if($query == "getreviewsbylancer" && isset($_GET["id"])){ //Get all reviews for a freelancer
	...
	else if($query == "searchcats" && isset($_GET["searchquery"])){ //Search all categories
	...
	else if($query == "searchlancers" && isset($_GET["searchquery"])){ //Search all freelancers
