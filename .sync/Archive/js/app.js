...
freelance.controller("viewCtrl", ["$scope","$http","$location", function($scope,$http,$location){
...
freelance.controller("chatCtrl", ["$scope","$http","$location", function($scope, $http, $location){
